...
export default function WorkCard({ img, title, desc }) {
  return (
    <div className="w-full h-full border rounded-2xl flex items-center sm:space-x-8 space-x-3 py-8 sm:px-0 px-3 sm:justify-center justify-between shadow-md bg-white">
